...
<p>
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=bash,ts,nodejs,express,php,laravel,mongodb,mysql,gcp,firebase,ai,regex,codepen,js,html,pug,css,sass,tailwind,angular,react,vue,redux,jquery,jest,git,bitbucket,github,postman,kubernetes,docker,jenkins,ansible,webstorm,vscode,vim&perline=9" />
  </a>
</p>
...
### Employer? 💼
> [!IMPORTANT]  
<a href="https://docs.google.com/document/d/17e6rIn4Hw9JzVxZA2y6quKKdXr1aZGU5/export?format=docx" download="eitan-pano-cv.docx">Download my resume</a>
